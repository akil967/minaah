...
if(!file_exists('config.json')){
	$token = readline('-Hi MORO Enter Token: ');
	$id = readline('-Hi MORO Enter Id: ');
...
$fackfor = "fack For everyone who steals my file or changes rights\n";
    $fackfor2 = "تبا لكل عاهره  يسرق ملفي او يغير الحقوق";
    echo $fackfor;
    echo $fackfor2;
...
لشراء نسخه مراسلة المطور 👁‍🗨',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'▫️| مطور البوت','url'=>'t.me/HVB79']],
                       [['text'=>"▪️| قناه صيد المشتركين", 'url'=>"t.me/HVB75"]],
                  ]
							])
					]);
				}
          ...
          if($data == 'login'){
            ...
            exec('screen -dmS gr php explore.php');
              ...
              $bot->sendMessage([
                'chat_id'=>$chatId,
                'text'=>"🎣 - تم بدأ الصيد برعاية ميرو برو 𖡦-› 
